...
const Vildskud = (0, import_index_e03aaaec.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<section class="${"header svelte-17h29e0"}"><h4>Spring 2022</h4>
	<h2>Vildskud festival</h2>
	<img src="${"Mask Group 28.png"}" alt="${"m! app"}" class="${"svelte-17h29e0"}"></section>
<section class="${"content svelte-17h29e0"}"><div class="${""}"><h2>Designing for sustainability</h2>
...
<section class="${"content svelte-17h29e0"}"><img src="${"Group 68.png"}" alt="${"m! app"}" class="${"svelte-17h29e0"}">
	<div class="${""}"><h2>Redefining the logo</h2>
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, quod totam in alias aliquam
			autem tempore est voluptatum modi mollitia saepe exercitationem quis? Temporibus, voluptatum.
			Suscipit debitis, soluta a quos accusamus tempora. Velit voluptas, autem temporibus sit
			quaerat impedit exercitationem animi labore unde eveniet architecto ratione, tempora magni
...
<section class="${"content svelte-17h29e0"}"><div class="${""}"><h2>Show it don&#39;t tell it</h2>
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, quod totam in alias aliquam
			autem tempore est voluptatum modi mollitia saepe exercitationem quis? Temporibus, voluptatum.
			Suscipit debitis, soluta a quos accusamus tempora. Velit voluptas, autem temporibus sit
			quaerat impedit exercitationem animi labore unde eveniet architecto ratione, tempora magni
	...
	<img src="${"stk_3.svg"}" alt="${"m! app"}" class="${"svelte-17h29e0"}"></section>
